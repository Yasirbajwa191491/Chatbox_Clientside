...
import { actionTypes, PendingInvitation, Friend, OnlineUser, GroupChatDetails, ResetFriends,UserGetNotification,OnlineNotifaction } from "./types";
...
export const setNotifications = (
    notifications: OnlineNotifaction[]
) => {
    return {
...
export const setUserNotifcations = (
    usernotifications: UserGetNotification[]
) => {
    return {
