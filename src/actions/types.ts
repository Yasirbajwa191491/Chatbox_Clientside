...
import { setNotifications } from "./friendActions";
...
export interface OnlineNotifaction {
    department: string;
...
interface setNotifications {
    ...
    payload: Array<OnlineNotifaction>;
}
...
export interface UserGetNotification {
    userId: string,
    messages:Array<[]>;
}
...
interface setUserNotifcations {
    type: actionTypes.setUserNotifcations;
    payload: Array<UserGetNotification>;
}
...
export interface SetGroupNotifications {
